    ...
    if(show.includes(blog.id)){
      result = (
        <div>
          ...
          <div>Likes: {blog.likes} <button id="like-button" onClick={(event) => handleLike(event, blog)}>like</button></div>
          <div>Added by: {blog.user.name} {owner && <button id="delete-button" onClick={(event) => handleDelete(event, blog)}>delete</button>}</div>
          <button id="hide-button" onClick={(event) => handleClick(event, blog)}>hide</button>
        </div>
      )
    } else {
      result = (
        <div>
          ...
          <button id="view-button" onClick={(event) => handleClick(event, blog)}>view</button>
        </div>
      )
    }
    return result
