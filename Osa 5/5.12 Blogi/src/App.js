  ...
  return (
    <div>
      ...
      {blogs.sort((a, b) => b.likes - a.likes).map(blog =>
        <Blog key={blog.id} blog={blog} blogs={blogs} setBlogs={setBlogs} user={user} notifications={notifications}/>
      )}
      ...
      <div style={showWhenVisible}>
        <BlogForm notifications={notifications} setBlogFormVisible={setBlogFormVisible} blogs={blogs} setBlogs={setBlogs} user={user}/>
